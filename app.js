...
app.get("/posts/new/details", (req, res) => {
...
// creating an image
app.post("/posts", upload.single("image"), isLoggedIn, (req, res) => {
...
// editing a post
app.patch("/posts/:id", isLoggedIn, isUser, validatePost, catchAsync(async (req, res) => {
    const id = req.params.id;
...
// deleting a post
app.delete("/posts/:id", isLoggedIn, isUser, catchAsync(async (req, res) => {
    const id = req.params.id;
...
// liking a post
app.patch("/posts/:id/like", isLoggedIn, catchAsync(async (req, res) => {
    const id = req.params.id;
    const post = await Post.findById(id);
